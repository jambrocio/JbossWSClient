...
public class ObjectFactory {
    ...
    private final static QName _DivideResponse_QNAME = new QName("http://webservice.com/", "divideResponse");
    private final static QName _SumaResponse_QNAME = new QName("http://webservice.com/", "sumaResponse");
    private final static QName _Resta_QNAME = new QName("http://webservice.com/", "resta");
    private final static QName _Divide_QNAME = new QName("http://webservice.com/", "divide");
    private final static QName _MultiplicaResponse_QNAME = new QName("http://webservice.com/", "multiplicaResponse");
    private final static QName _Suma_QNAME = new QName("http://webservice.com/", "suma");
    private final static QName _Multiplica_QNAME = new QName("http://webservice.com/", "multiplica");
    private final static QName _RestaResponse_QNAME = new QName("http://webservice.com/", "restaResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.com/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.com/", name = "sumaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.com/", name = "resta")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.com/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.com/", name = "multiplicaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.com/", name = "suma")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.com/", name = "multiplica")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.com/", name = "restaResponse")
